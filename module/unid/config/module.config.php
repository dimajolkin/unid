...
//                 'type'    => 'Segment',
//                 'options' => array(
//                     'route'       => '/user[/:controller][/:action][/:id_table][/:id]',
//                     'constraints' => array(
//                         'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
//                     ),
//                     'defaults' => array(
...
//                'type'    => 'Segment',
//                'options' => array(
//                    'route'       => '/kafedra[/:controller][/:action][/:id_table][/:id][/:login]',
//                    'constraints' => array(
//                        'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
//                    ),
//                    'defaults' => array(
