<?php
namespace unid\Controller\NPR;

use unid\Controller\unidControllerAbstract;
...
use unid\Controller\BaseActionController;
use Zend\Json\Json;


class IndexController extends unidControllerAbstract
{
    ...
    function indexAction()
    {
        ...
        $status = new StatusWork(self::getAdapter());
